...
def main():
    ...
    if not os.path.isfile(app_toml_path) or not os.path.isfile(main_py_path):
    ...
    app_toml = app_toml.replace('entry = "main.py"', 'entry = "main.py"')

    main_py = load_template(main_py_path)

    os.makedirs(app_dir, exist_ok=True)
    write_file(os.path.join(app_dir, "app.toml"), app_toml)
    write_file(os.path.join(app_dir, "main.py"), main_py)
