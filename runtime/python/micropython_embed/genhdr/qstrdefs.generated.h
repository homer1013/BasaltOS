...
// --- BasaltOS extra qstrs (hand-added) ---
QDEF0(MP_QSTR_add, 12868, 3, "add")
QDEF0(MP_QSTR_show, 43654, 4, "show")
QDEF0(MP_QSTR_on_press, 14684, 8, "on_press")
QDEF0(MP_QSTR_set_text, 12229, 8, "set_text")
QDEF0(MP_QSTR_screen, 12553, 6, "screen")
QDEF0(MP_QSTR_button, 24819, 6, "button")
QDEF0(MP_QSTR_label, 59203, 5, "label")
QDEF0(MP_QSTR_set_title, 2712, 9, "set_title")
QDEF0(MP_QSTR_Screen, 54505, 6, "Screen")
QDEF0(MP_QSTR_Button, 58067, 6, "Button")
QDEF0(MP_QSTR_Label, 1891, 5, "Label")
QDEF0(MP_QSTR_text, 44952, 4, "text")
QDEF0(MP_QSTR_x, 46557, 1, "x")
QDEF0(MP_QSTR_y, 46556, 1, "y")
QDEF0(MP_QSTR_w, 46546, 1, "w")
QDEF0(MP_QSTR_h, 46541, 1, "h")
